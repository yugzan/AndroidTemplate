...
/**
 * Created by yongzan on 2015/10/28.
 */
public class PushGCM {
     ...
     */
    public final static String SENDER_ID = "491782740385";
    ...
    // ----------類別介面----------
    public static interface PushGCMListener {
        /**
         * GCM註冊結束
         *
         * @param successfull
    ...
    private PushGCMListener listener;

    // ----------建構子----------
    public PushGCM(Activity activity) {
        this(activity, null);
    }

    public PushGCM(Activity activity, PushGCMListener listener) {
    ...
    public void setMagicLenGCMListener(PushGCMListener listener) {
    ...
    public String getRegistrationId() {
        ...
        // 檢查程式是否有更新過
        int registeredVersion = prefs.getInt(PushGCM.PROPERTY_APP_VERSION,
                Integer.MIN_VALUE);
